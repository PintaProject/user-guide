...
To illustrate all of the effects, we'll be using this photo of KFC.  
...
1. Go to **Effects** > **Photo** and select **Glow**. The **Glow** dialog box will appear.  
...
&nbsp;
3. Adjust the **Brightness** slider to control the intensity of the illumination. Higher values yield brighter images and lower values yield darker images.  
&nbsp;
...
The **Sharpen** effect is used to reduce softness and emphasize texture in an image to draw in viewer focus. A dialog box populates with a strength slider. The strength slider controls how pronounced the edges in an image appear, increasing the contrast of edges. 
 ...
 1. Go to **Effects** > **Photo** and select **Sharpen**. The **Sharpen** dialog box will appear.  
...
1. Go to **Effects** > **Photo** and select **Soften Portrait**. The **Soften Portrait** dialog box will appear.  
...
1. Go to **Effects** > **Blur** and select **Fragment**. The **Fragment** dialog box will appear.  
...
1. Go to **Effects** > **Blur** and select **Gaussian**. The **Gaussian** dialog box will appear.  
...
1. Go to **Effects** > **Blur** and select **Motion**. The **Motion** dialog box will appear.  
...
The **Radial Blur** effect is like the motion blur, but rather than following a linear path, it follows a circular one.  
 ...
 1. Go to **Effects** > **Blur** and select **Radial Blur**. The **Radial Blur** dialog box will appear.  
...
The **Unfocus Blur** effect is like the **Gaussian** blur but yields a more *dreamy* or unfocused look to the image or selected area.  
 ...
 1. Go to **Effects** > **Blur** and select **Unfocus**. The **Unfocus** dialog box will appear.  
...
The **Zoom Blur** effect is used to give the appearance of motion towards the focal point of an image, as if the viewer were closing in on the focal point. It's like the **Motion** blur but applied outwards from a central point. 

1. Go to **Effects** > **Blur** and select **Zoom Blur**. The **Zoom Blur** dialog box will appear.  
...
1. Go to **Effects** > **Distort** and select **Bulge**. The **Bulge** dialog box will appear.  
...
1. Go to **Effects** > **Distorted** and select **Frosted Glass**. The **Frosted Glass** dialog box will appear.  
...
1. Go to **Effects** > **Distorted** and select **Pixelate**. The **Pixelate** dialog box will appear.  
...
1. Go to **Effects** > **Distorted** and select **Polar Inversion**. The **Polar Inversion** dialog box will appear.  
...
The **Edge Behavior** drop-down selection defines how the effect behaves as the transformation reaches, then exceeds the edge of the canvas.  
...
1. Go to **Effects** > **Distorted** and select **Tile Reflection**. The **Tile Reflection** dialog box will appear.  
![tilereflectionbox](img/tilereflectionbox.PNG)  

2. Adjust the **Rotation** circle slider to control the angle at which the tiles appear. It can be rotated 360 degrees.  

3. Adjust the **Tile Size** slider to control how big or how small the tiles appear: they always remain square. A higher value yields larger tiles.  
...
1. Go to **Effects** > **Distorted** and select **Twist**. The **Twist** dialog box will appear.  
...
1. Go to **Effects** > **Artistic** and select **Ink Sketch**. The **Ink Sketch** dialog box will appear.  
...
The **Oil Painting** effect makes the image appear as if it were painted with oil paints.  

1. Go to **Effects** > **Artistic** and select **Oil Painting**. The **Oil Painting** dialog box will appear.  
...
1. Go to **Effects** > **Artistic** and select **Pencil**. The **Pencil** dialog box will appear.  
...
1. Go to **Effects** > **Render** and select **Clouds**. The **Cloud** dialog box will appear.  
...
2. Adjust the **Scale** slider to control the size of clouds. Higher values yield larger clouds and lower values yield finer clouds.  
      ...
      * Drag slider to the left to decrease cloud size.  
      &nbsp;
3. Adjust the **Power** slider to control how coarse or how fluffy the clouds appear, dealing with their texture. Higher values yield coarser, more detailed clouds and lower values yield softer, more blurred clouds.  
&nbsp;
      * Drag slider to the right to increase cloud texture.  
      * Drag slider to the left to decrease cloud texture.  
&nbsp;
4. Select a **Blend Mode** from the drop-down menu to configure how the rendered clouds will be blended with the original image or layer.  

See a full list of blend modes and their deciprtions in the [Edit Layer Properties](edit.md#apply-blend-mode) page.
...
1. Go to **Effects** > **Render** and select **Julia Fractal**. The **Julia Fractal** dialog box will appear.  
...
1. Go to **Effects** > **Render** and select **Mandelbrot Fractal**. The **Mandelbrot Fractal** dialog box will appear.  
...
1. Go to **Effects** > **Stylize** and select **Edge Detect**. The **Edge Detect** dialog box will appear.  
...
1. Go to **Effects** > **Stylize** and select **Emboss**. The **Emboss** dialog box will appear.  
...
1. Go to **Effects** > **Stylize** and select **Outline**. The **Outline** dialog box will appear.  
...
1. Go to **Effects** > **Stylize** and select **Relief**. The **Relief** dialog box will appear.  
