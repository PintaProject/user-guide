...
2. From the **Choose Primary** or **Choose Secondary** Menu you have the following options to set the color:  
    ...
    -  **Eye Dropper**: Click on the eyedropper ![eye dropper](img/color/eyedropper.png) and then click a color anywhere on your screen to seclect that color.  The "Eye Dropper" tool can also be accessed from the **Tools** menu (referenced as a Color Picker) 
